...
#use these to plot wave after giving it file name
# record = wfdb.rdrecord('path_to_record_name')
# wfdb.plot_items(record.p_signal)

def plot_record(record_name):
...
# allow it to run in terminal by taking in input
if __name__ == '__main__':
    #use plot_record to plot waveform
